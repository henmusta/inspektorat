	...
	<div class="row page-titles mx-0 ">
		...
		<div class="col-sm-6 p-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a href="javascript:void(0)">Edit Galeri</a></li>
			</ol>
		</div>
	</div>
@php
    $ximage_url = isset($galeri->value) ? asset('storage/galeri-images/'.$galeri->value) : asset('images/noimage.jpg');
@endphp
	<form action="{{ route('galeri.admin.update', $galeri->id) }}" id="formStore" method="post" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-md-12">
				<div class="row">
							...
							<div class="card-body p-4">
								<div class="row">
									<div class="form-group col-md-12">
										...
										<input type="text" name="data[Galeri][title]" class="form-control" id="GaleriTitle" value="{{$galeri->title ?? ''}}" placeholder="Judul" value="">
                                        ...
                                        <div class="card accordion accordion-rounded-stylish accordion-bordered XFeaturedImage" id="accordion-feature-image">
                                            ...
                                            <div class="accordion__body p-4 collapse show" id="with-feature-image" data-bs-parent="#accordion-feature-image">
                                                <div class="featured-img-preview img-parent-box">
                                                    ...
                                                    <img src="{{ $ximage_url }}" class="avatar img-for-onchange"  alt="{{ __('Image') }}" width="100px" height="100px" title="{{ __('Image') }}">
{{--
