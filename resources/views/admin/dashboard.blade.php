		...
		<div class="col-xl-9 col-xxl-8">
			<div class="card">
				<div class="card-header border-0 flex-wrap pb-0">
					<div class="mb-3">
						<h4 class="fs-20 text-black">{{ __('Users Overview') }}</h4>
						<p class="mb-0 fs-12 ">{{ __('How Many Users Joins in a Month') }}</p>
					</div>
				</div>
		...
		<div class="col-xl-3 col-xxl-4">
			<div class="card">
				<div class="card-header border-0 pb-0">
					<h4 class="fs-20 text-black">{{ __('Blog Categories Statistic') }}</h4>
				</div>
